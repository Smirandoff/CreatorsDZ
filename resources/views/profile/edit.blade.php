		...
		<div class="bloc_dyn col-lg-9">
		    <div class="row">
				...
				<div class="col-sm-12 col-lg-8 col-md-8">
					...
					<p><button class="btn btn-outline-success">Charger l'image</button></p>
				</div>			
		...
		<div class="col-xs-12 col-lg-12">
			<nav>
	    		<div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
					<a class="nav-item nav-link active" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="true">Détails du profile</a>
					<a class="nav-item nav-link" id="nav-access-tab" data-toggle="tab" href="#nav-access" role="tab" aria-controls="nav-access" aria-selected="false">Détails d'accès</a>
				</div>
			</nav>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="phone_number" class="form-control border-form-control @error('phone_number') is-invalid @enderror" value="{{$user->phone_number}}" placeholder="+213 000 000 000" type="number">
                                </div>
                                @error('phone_number')
                                <div class="invalid-feedback">
                                    {{$message}}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="bank" class="form-control border-form-control @error('bank') is-invalid @enderror" value="{{$user->bank}}" placeholder="Algérie poste" type="text">
                                </div>
                                @error('bank')
                                <div class="invalid-feedback">
                                    {{$message}}
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="rib" class="form-control border-form-control @error('rib') is-invalid @enderror" value="{{$user->rib}}" placeholder="0000000000" type="text">
                                </div>
                                @error('rib')
                                <div class="invalid-feedback">
                                    {{$message}}
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control border-form-control @error('address') is-invalid @enderror" name="address" max="255" >{{$user->address}}</textarea>
                                </div>
                                @error('address')
                                <div class="invalid-feedback">
                                    {{$message}}
					    ...
					    <div class="row">
						    <div class="col-sm-7">
							    <div class="form-group">
								    ...
								    <input name="password" class="form-control border-form-control " value="" placeholder="Ancien mot de passe" type="password">
							    </div>
						    </div>
						    <div class="col-sm-7">
							    <div class="form-group">
								    <label class="control-label">Nouveau mot de passe <span class="required">*</span></label>
					    		    <input name="password" class="form-control border-form-control" value="" placeholder="Nouveau mot de passe" type="password">
							    </div>
                            </div>
                            <div class="col-sm-7">
							    <div class="form-group">
